  ...
  const pageContent = page?.content || `
    <div class="space-y-8">
      <div class="flex justify-center mb-8">
        <img src="/images/aaa.png" alt="원장님" class="rounded-lg shadow-lg max-w-md w-full" />
      </div>

      <div class="space-y-6 text-gray-700 leading-relaxed">
        <p class="text-lg font-semibold text-center text-primary">
        ...
        <p class="text-right pt-8">
          <span class="text-gray-900 font-medium">자람동산 어린이집 원장</span>
        </p>
      </div>
    </div>
  `
